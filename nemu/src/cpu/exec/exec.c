...
opcode_entry opcode_table [512] = {
  ...
  /* 0x20 */	EMPTY, IDEX(G2E,and), IDEXW(E2G,and,1), EMPTY,
  ...
  /* 0x48 */	IDEX(r,dec), EMPTY, IDEX(r,dec), EMPTY,
  ...
  /* 0x68 */	IDEXW(I,push,4), EMPTY, IDEXW(I,push,1), EMPTY,
  ...
  /* 0xe4 */	IDEXW(in_I2a,in,1), IDEXW(in_I2a,in,4), IDEXW(out_a2I,out,1), IDEXW(out_a2I,out,4),
  /* 0xe8 */	IDEXW(J,call,4), IDEXW(J,jmp,4), EMPTY, IDEXW(J,jmp,1),
  /* 0xec */	IDEXW(in_dx2a,in,1), IDEX(in_dx2a,in), IDEXW(out_a2dx,out,4), IDEX(out_a2dx,out),
  ...
  /* 0x84 */	IDEXW(J,jcc,4), IDEXW(J,jcc,4), IDEXW(J,jcc,4), EMPTY,
  /* 0x88 */	IDEXW(J,jcc,4), EMPTY, EMPTY, EMPTY,
  /* 0x8c */	IDEXW(J,jcc,4), EMPTY, IDEXW(J,jcc,4), EMPTY,

...
opcode_entry opcode_table [512] = {
  ...
  /* 0x38 */	IDEXW(G2E,cmp,8), IDEX(G2E,cmp), EMPTY, IDEX(E2G,cmp),
  /* 0x3c */	IDEXW(I2a,cmp,1), EMPTY, EMPTY, EMPTY,
  /* 0x40 */	IDEX(r,inc), EMPTY, EMPTY, IDEX(r,inc),
  ...
  /* 0x58 */	EMPTY, EMPTY, EMPTY, IDEX(r,pop),
  ...
  /* 0x7c */	IDEXW(J,jcc,1), EMPTY,IDEXW(J,jcc,1), IDEXW(J,jcc,1),
  ...
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G,movsx,1), EMPTY,
